...
public class Main {
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            ExerciseBrowserView exerciseBrowserView = new ExerciseBrowserView(workoutSessionView);
            ...
            tabbedPane.addTab("Exercise Library", exerciseBrowserView);
            ...
            Runtime.getRuntime().addShutdownHook(new Thread(() -> {
                if (exerciseBrowserView != null) {
                    exerciseBrowserView.cleanup();
                }
            }));
        });
